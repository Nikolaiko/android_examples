# Примеры разных моментов разработки для Android
...
3. Простой пример использования библиотек : Toothpick, Room [ShelterApp](https://github.com/Nikolaiko/android_examples/tree/master/Shelter)
